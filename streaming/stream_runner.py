...
for step in range(10000):
    ...
    if random.random() < fraud_probability:
        ...
        if isinstance(transaction, list):
            ...
            if transaction is not None:
                ...
                transaction = enrich_transaction(
                    transaction,
                    user
                )
    ...
    # ============================================
    # UPDATE USER SPENDING BEHAVIOR
    # ============================================

    recent_history = (
        user["transaction_history"][-20:]
    )
